...
Contributions are welcome. `go-ruby-toml/toml` is built to a small set of
...
The library is in [`github.com/go-ruby-toml/toml`](https://github.com/go-ruby-toml/toml).
This documentation site is in [`github.com/go-ruby-toml/docs`](https://github.com/go-ruby-toml/docs).
